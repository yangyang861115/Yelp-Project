...
with open("/Users/huzefa/Workspace/College-Fall-2015/Search/Dataset/XAll.processed", 'rb') as f:
    global XAll
    XAll= pickle.load(f)
    
with open("/Users/huzefa/Workspace/College-Fall-2015/Search/Dataset/YAll.processed") as f:
    global yAll 
    yAll= pickle.load(f)
...
with open("/Users/huzefa/Workspace/College-Fall-2015/Search/Dataset/svc60.classifier") as f:
    global classifier
